...
// Hero Component
export const HeroTemplate = React.memo(() => {
  return (
    <section
      ...
      <div className="w-full max-w-5xl relative pb-20">
        ...
        >
          <img
            ...
            alt="glow background texture"
            className="w-full h-auto opacity-50 blur-[50px] mix-blend-screen"
            loading="eager"
